    ...
    <div class="my-4 py-4 px-4 mx-auto max-w-screen-xl lg:py-8 lg:px-0">
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3 ">
            @forelse ($posts as $post)
                <article {{-- dark:bg-gray-800 dark:border-gray-700 --}} class="p-6 bg-white rounded-lg border border-gray-200 shadow-md ">
                    <div class="flex justify-between items-center mb-5 text-gray-500">
                        <a href="/posts?category={{ $post->category->slug }}">
                            <span {{-- dark:bg-primary-200 dark:text-primary-800 --}}
                                class="{{ $post->category->color }} text-white text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded ">
                    ...
                    <a href="/posts/{{ $post->slug }}">
                        <h2 {{-- dark:text-white --}}
                            class="mb-2 text-2xl font-bold tracking-tight text-gray-900 hover:underline">
                            {{ $post->title }}
                        </h2>
                    </a>
                    <p {{-- dark:text-gray-400 --}} class="mb-5 font-light text-gray-500 ">
            ...
            @empty
                <div>
                    ...
                    <a href="/posts"
                        class="inline-flex items-center font-medium text-primary-600  hover:underline">&laquo;
                        Back to all posts</a>
                </div>
            @endforelse
        </div>
